...
for nshell in nshells:
    for seed in seeds:
        ...
        dir_smoorhed_maps = '/global/cscratch1/sd/jatorres/smoothed_maps/HACC150/'#os.path.join(os.getcwd(),'smoothed/')
        ...
        for i in range(kappa_maps_field.Nbins):
            ...
            hp.write_map(dir_smoorhed_maps+wname.split('.')[0]+'_nshell%d.fits'%nshell,smoothed_map,overwrite=True)